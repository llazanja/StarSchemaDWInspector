...
class Atribute extends Component {
  onIsCheckedClick = () => {
    this.props.handleIsCheckedToggle(this.props.tableID, this.props.atributeNumber, !this.props.isChecked);
  };

  render() {
    const { name, isChecked } = this.props;
    return (
      <div className="row mx-4 p-1 border-bottom">
